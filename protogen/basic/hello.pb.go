...
func (x *Heartbeat) Reset() {
	*x = Heartbeat{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_basic_hello_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Heartbeat) Descriptor() ([]byte, []int) {
	return file_proto_basic_hello_proto_rawDescGZIP(), []int{1}
}
...
var file_proto_basic_hello_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x62, 0x61, 0x73, 0x69, 0x63,
	...
	,
...
var file_proto_basic_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_basic_hello_proto_goTypes = []interface{}{
	(*Hello)(nil),         // 0: basic.Hello
	(*Heartbeat)(nil),     // 1: basic.Heartbeat
	(*emptypb.Empty)(nil), // 2: google.protobuf.Empty
}
var file_proto_basic_hello_proto_depIdxs = []int32{
	2, // 0: basic.HeartbeatService.CheckHeartbeat:input_type -> google.protobuf.Empty
	1, // 1: basic.HeartbeatService.CheckHeartbeat:output_type -> basic.Heartbeat
...
func file_proto_basic_hello_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_basic_hello_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
