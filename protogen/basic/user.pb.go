...
type User struct {
	...
	CommunicationChannels []*anypb.Any `protobuf:"bytes,16,rep,name=communication_channels,json=communicationChannels,proto3" json:"communication_channels,omitempty"`
}
...
func (x *User) GetCommunicationChannels() []*anypb.Any {
	if x != nil {
